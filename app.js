    ...
    <div id="laporanPrintArea">
      <div style="background:var(--white);border-radius:var(--radius);padding:18px;margin-bottom:14px;box-shadow:var(--shadow-sm)">
        ...
        <div class="laporan-summary">
          ...
          <div class="stat-card yellow"><div class="stat-icon"><i class="fas fa-coins"></i></div><div class="stat-info"><span class="stat-label">Kas Masuk</span><span class="stat-value" style="font-size:14px">${formatRp(totalMasuk)}</span></div></div>
          <div class="stat-card red"><div class="stat-icon"><i class="fas fa-file-invoice"></i></div><div class="stat-info"><span class="stat-label">Tunggakan</span><span class="stat-value" style="font-size:14px">${formatRp(totalSisa)}</span></div></div>
      ...
      <div class="table-container">
        <table class="data-table">
          ...
          <tbody>
            ...
            }).join('') : `<tr><td colspan="8" class="empty-row">Tidak ada data untuk periode ini.</td></tr>`}
          </tbody>
          ${filtered.length ? `<tfoot>
            <tr style="background:var(--green-dark);color:white;font-weight:700">
              <td colspan="4" style="padding:10px 13px">TOTAL</td>
